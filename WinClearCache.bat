...
if %errorLevel% neq 0 (
    ...
    if exist "%safari_cache%\Webpage Previews" (
        echo Deleting Safari Webpage Previews...
        del /q /f /s "%safari_cache%\Webpage Previews\*" >nul 2>&1
        rd /s /q "%safari_cache%\Webpage Previews" >nul 2>&1
    ) else (
        echo Directory not found: "%safari_cache%\Webpage Previews"
    )
    ...
    :: Cleaning System Restore Points (requires administrative privileges)
